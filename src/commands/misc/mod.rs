        ...
        .send_noret(ctx, |m: &mut MessageCreator| {
            m.title("About")
                .content(
                    ...
                    Inori-rs is now a fully open source SelfBot available to \
                    the public. (Named after [Inori Yuzuriha]\
                ...
                .field(
                    "Library",
                    "[Serenity v0.9.4](https://github.com/serenity-rs/serenity) \
                    with [SelfBot support](https://github.com/L3afMe/serenity-selfbot-support)",
                    true,
                )
                .field(
                    "Author",
